...
DECLARE_CLASS_CODEGEN(
    ...
    DECLARE_CTOR(ctor, GlobalNamespace::AudioTimeSyncController* audioTimeSyncController, GlobalNamespace::ComboController* comboController, GlobalNamespace::ComboUIController* comboUIController);
