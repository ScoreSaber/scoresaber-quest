...
DECLARE_CLASS_CODEGEN(
    ...
    DECLARE_INSTANCE_FIELD_PRIVATE(GlobalNamespace::GameEnergyCounter*, _gameEnergyCounter);
    DECLARE_INSTANCE_FIELD_PRIVATE(GlobalNamespace::GameEnergyUIPanel*, _gameEnergyUIPanel);
