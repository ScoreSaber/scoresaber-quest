...
DECLARE_CLASS_CODEGEN(
    ...
    DECLARE_CTOR(ctor, GlobalNamespace::AudioTimeSyncController* audioTimeSyncController, GlobalNamespace::GameEnergyCounter* _gameEnergyCounter, GlobalNamespace::GameEnergyUIPanel* _gameEnergyUIPanel);
