...
namespace DelegateUtils
{
    ...
    struct DelegateW
    {
        ...
        constexpr FixedSafePtr<T>* operator->() noexcept { return &internalCSharpDelegate; }
        constexpr FixedSafePtr<T> const* operator->() const noexcept { return &internalCSharpDelegate; }
        constexpr operator bool() const noexcept { return internalCSharpDelegate; }

        private:
        FixedSafePtr<T> internalCSharpDelegate;
    };
